...
const Hero = () => {
  return (
    <div className="relative min-h-screen">
      <Image
        className="lg:w-[580px] xl:w-[620px] h-[600px] border-rounded absolute right-0 top-20 -z-10"
        src="/DEL.jpg"
        width={1000}
        height={800}
        alt="hero_bg"
      ...
      <div className="container h-[calc(100vh-120px)] grid items-center">
        <div className="space-y-4 bg-[#ffffff98] w-fit p-4">
          <p className="uppercase font-medium">Different Variety of choice</p>
          <h2 className="text-4xl sm:text-6xl font-bold">
          Delightful <span className="text-accent">Food</span>
          </h2>
